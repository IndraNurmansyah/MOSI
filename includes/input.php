<center>
	<form method="post" name"hitung" action="tabelhitung.php">
		<table id="box-table-c" align="center">
		  ...
		  <tr>
		  	<td>16</td>
		    <td><input type="text" name="x16" value="0" class="input_field" maxlength="8" /></td>
		    <td><input type="text" name="y16" value="0" class="input_field" maxlength="8" /></td>
		  </tr>
		  <tr>
		  	<td>17</td>
		    <td><input type="text" name="x17" value="0" class="input_field" maxlength="8" /></td>
		    <td><input type="text" name="y17" value="0" class="input_field" maxlength="8" /></td>
		  </tr>
		  <tr>
		  	<td>18</td>
		    <td><input type="text" name="x18" value="0" class="input_field" maxlength="8" /></td>
		    <td><input type="text" name="y18" value="0" class="input_field" maxlength="8" /></td>
		  </tr>
		  <tr>
		  	<td>19</td>
		    <td><input type="text" name="x19" value="0" class="input_field" maxlength="8" /></td>
		    <td><input type="text" name="y19" value="0" class="input_field" maxlength="8" /></td>
		  </tr>
		  <tr>
		  	<td>20</td>
		    <td><input type="text" name="x20" value="0" class="input_field" maxlength="8" /></td>
		    <td><input type="text" name="y20" value="0" class="input_field" maxlength="8" /></td>
		  </tr>
		  <tr>
		  	<td colspan="3"><input type="submit" value="HITUNG" id="submit" name="submit" class="submit_btn left" /></td>
		  </tr>
		</table>
	</form>
</center>